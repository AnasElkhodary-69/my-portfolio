    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-700 rounded-lg p-8 shadow-lg text-center">
            <div className="mb-8">
              <svg
                className="w-16 h-16 mx-auto text-blue-600 dark:text-blue-400 mb-4"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div className="border-t border-gray-300 dark:border-gray-600 pt-8">
              ...
              <div className="flex justify-center gap-6">
                <a
                  href="https://github.com/AnasElkhodary-69"
                  target="_blank"
                ...
                <a
                  href="https://www.facebook.com/anas.radwan.930838/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  aria-label="Facebook"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {submitStatus === 'error' && (
                  <div className="p-4 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg text-red-800 dark:text-red-200">
                    Failed to send message. Please try again or email me directly at anaselkhodary69@gmail.com
                  </div>
                )}
