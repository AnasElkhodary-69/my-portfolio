...
A modern, professional portfolio website showcasing my expertise in Product Building, AI Engineering, ERP Migration, and SaaS applications.
...
- **📊 Project Showcase**: 13 production projects with detailed information
...
7. **SavetyAI Website** - AI-powered cybersecurity platform with modern design ([savety.ai](https://savety.ai))
8. **SalesBreach PRO** - Enterprise email marketing automation (24/7 Production)
9. **Sales Master** - Multi-tenant SaaS email platform, security-hardened ([marketing.ai2go.vip](https://marketing.ai2go.vip))
10. **SDS Automation** - Production RAG email system with Mistral + Claude agents and 99.9% uptime
11. **IKRAA + OOLA** - Arabic learning platform with store purchases on mobile and Stripe/PayPal on web ([app.oo-la.com](https://app.oo-la.com))
12. **AI2GO Education Analytics** - Government-scale education data unification platform ([edu.ai2go.vip](https://edu.ai2go.vip))
13. **TNG Odoo ERP Migration** - Full Monday.com → Odoo 19.0 Enterprise migration with Google Voice telephony, 5 custom modules & 300+ automation scripts
